...
class CreateDocumentosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('documentos', function (Blueprint $table) {
            ...
            $table->bigInteger('proyect_id')->unsigned()->nullable();
            ...
            $table->foreign('proyect_id')->references('id')->on('proyectos')->onDelete('cascade')->onUpdate('cascade');
            $table->foreign('departament_id')->references('id')->on('departamentos')->onDelete('cascade')->onUpdate('cascade');
